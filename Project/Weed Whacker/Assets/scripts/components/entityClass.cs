...
public class EntityClass : MonoBehaviour
{
    ...
    [HideInInspector] public UnityEvent onHit; //for if the entity in question does specific things when struck; any associated functions should be set IN THE EDITOR
    [HideInInspector] public UnityEvent onDeath; //same as onHit, but for death
